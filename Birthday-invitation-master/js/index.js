var dialogs = [
	{
	  index: 0,
	  content: "🌺 ¡Aloha, amig@! Estás oficialmente invitad@ a mi fiesta de cumpleaños al estilo *Lilo y Stitch* 🏝️🎉",
	  costume: 1,
	},
	{
	  index: 1,
	  content: "✨ ¡REBECA VIRGINIA BENEDITH te espera con collares de flores, bebidas tropicales y mucha buena vibra! 🍹🌈",
	  costume: 2,
	},
	{
	  index: 2,
